...
function ChatBot({ onMarkdownUpdate, gameName, projectId }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("Spec question error:", error);
                            ...
                            <button
                              ...
                              onClick={async () => {
                                ...
                                const questionAnswerPairs =
                                  item.messages.reduce((acc, msg, msgIndex) => {
                                    if (msg.type !== "comment") {
                                      acc.push({
                                        question: msg.text,
                                        answer:
                                          answers[`q-${index}-${msgIndex}`],
                                      });
                                    }
                                    return acc;
                                  }, []);
