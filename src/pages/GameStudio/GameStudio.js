...
const GameStudio = () => {
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      setChatMessages((prev) => [
        ...
        {
          type: "ai",
          text: "네, 해당 내용을 수정하여 게임에 반영 중입니다... 🛠️",
        },
      ]);
    }, 1000);
  };
  ...
  const handleAssetUpload = (file) => {
    ...
    setAssets((prev) =>
      prev.map((a) =>
        a.id === assetModal.asset.id ? { ...a, src: url, name: file.name } : a
      )
    );
  ...
  const handleAssetPrompt = (promptText) => {
    ...
    setTimeout(
      () =>
        setChatMessages((prev) => [
          ...prev,
          { type: "ai", text: "요구사항을 반영하여 에셋을 업데이트했습니다." },
        ]),
      800
    );
    closeAssetModal();
    ...
    <div className="game-studio">
      ...
      <div className="studio-body">
        ...
        <div className="chat-panel">
          ...
          <img
            src={`${process.env.PUBLIC_URL}/images/talking_alpaca.gif`}
            alt="alpaca"
            className="chat-alpaca"
          />
              ...
              <div className="asset-modal-controls">
                <label className="upload-label">
                  ...
                  <input
                    ...
                    onChange={(e) => handleAssetUpload(e.target.files?.[0])}
                  />
                </label>
